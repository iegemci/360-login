...
import com.enesgemci.loginvuz.core.extension.dpToPx
...
class MDrawable private constructor(context: Context) {
    ...
    init {
        pressedColor = ContextCompat.getColor(context, R.color.pressed_color)
    ...
    class Builder(val context: Context) {
         ...
         *see [Type]
         */
        fun addType(types: LinkedHashSet<Type>): Builder {
            types
    ...
    private fun getDrawable(
        ...
        when (shape) {
            Shape.RECTANGLE -> getRectDrawable(color, outerRadii)
            Shape.OVAL -> getOvalDrawable(color)
            //            case GRADIENT:
    ...
    private fun getBorderDrawable(
        ...
        when (shape) {
            Shape.RECTANGLE -> getRectBorderDrawable(color, outerRadii, borderWidth)
            Shape.OVAL -> getOvalBorderDrawable(color, borderWidth)
            //            case GRADIENT:
